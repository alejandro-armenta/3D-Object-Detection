...
def create_model(configs):
    ...
    if (configs.arch == 'darknet') and (configs.cfgfile is not None):
        ...
        model = fpn_resnet.get_pose_net(num_layers=configs.num_layers, heads=configs.heads, head_conv=configs.head_conv, imagenet_pretrained=configs.imagenet_pretrained)
...
def detect_objects(input_bev_maps, model, configs):
    ...
    with torch.no_grad():  
        ...
        # perform inference
        #NOTE: Look at forward function in PoseResNet
        ...
        if 'darknet' in configs.arch:
            ...
            detections = decode(outputs['hm_cen'], outputs['cen_offset'], outputs['direction'], outputs['z_coor'], outputs['dim'], K=configs.max_objects)
            ...
            #print("detections_pp: ", detections_pp)
    ...
    ## step 1 : check whether there are any detections
        for detection in detections:
            ...
            mts_ppixel_x = configs.lim_x[1] - configs.lim_x[0] / configs.bev_height
            mts_ppixel_y = configs.lim_y[1] - configs.lim_y[0] / configs.bev_width
    ...
    print("Objects in 3D space", objects)
